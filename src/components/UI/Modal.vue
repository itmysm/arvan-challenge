    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-info text-black" @click="handleClose">
            {{ cancelText }}
          </button>
          <button type="button" class="btn btn-danger text-white" :disabled="loading" @click="handleConfirm">
